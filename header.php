...
=====================================================
    - این نسخه به طور کامل از سیستم JWT جدا شده و از یک روش سشن مبتنی
      بر دیتابیس و کوکی استفاده می‌کند.
    - در هر بار بارگذاری، شناسه سشن را از کوکی 'user_session' می‌خواند و
      آن را در دیتابیس جستجو می‌کند تا کاربر را شناسایی کند.
*/
