...
=====================================================
    ...
    - وضعیت لاگین از طریق سیستم JWT (پیاده‌سازی شده در header.php) بررسی می‌شود.
    - اطلاعات تکمیلی کاربر با استفاده از PDO از دیتابیس واکشی می‌شود.
*/
...
if (!$is_logged_in) {
    ...
    // این کار از دسترسی غیرمجاز به این صفحه جلوگیری می‌کند.
    header("Location: login.php");
    exit();
}


// --- گام ۳: واکشی اطلاعات تکمیلی کاربر از دیتابیس ---
